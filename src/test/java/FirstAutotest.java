...
public class FirstAutotest {
    ...
    public void testRgsInsurance() {
        ...
        Assert.assertEquals("Значение не соответствует ожидаемому ", expectedMultiTripsText, multiTrips.getAttribute("textContent").trim());
        Assert.assertEquals("Значение не соответствует ожидаемому ", expecterInsuranceText, tripInsurance.getAttribute("textContent").trim());
        Assert.assertEquals("Значение не соответствует ожидаемому ", expectedCountryText, tripCounry.getAttribute("textContent").trim());
        Assert.assertEquals("Значение не соответствует ожидаемому ", expectedDateOfBirthText, dateOfBirth.getAttribute("textContent").trim());
        Assert.assertEquals("Значение не соответствует ожидаемому ", expectedNameText, nameText.getAttribute("textContent").trim());
        Assert.assertEquals("Значение не соответствует ожидаемому ", expectedLeisureText, leisure.getAttribute("textContent").trim());
    }
